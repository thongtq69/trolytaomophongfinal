    ...
    <div className="w-full bg-[#f8fafc] flex flex-col gap-16 md:gap-20 pb-16 md:pb-20">
      ...
      <section className="relative min-h-[78vh] w-full flex items-center justify-center pt-6 md:pt-10 overflow-hidden">
        ...
        <div className="section-container flex flex-col lg:flex-row items-center gap-12 md:gap-14">
          <div className="flex-1 text-left space-y-8">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-sky-950 leading-[1.1] tracking-tight">
              Giảng dạy sáng tạo <br/>
              với <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-600 to-indigo-600">Simulab AI</span> <br/>
              thế hệ mới
            </h1>
      ...
      <section id="features" className="section-container space-y-12 md:space-y-14">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-black text-sky-950 leading-tight">Biến Ý Tưởng Thành Mô Phỏng Tương Tác</h2>
          <p className="text-slate-500 text-lg">Chỉ với những dòng mô tả đơn giản bằng tiếng Việt, Simulab AI sẽ tự động thiết kế các mô hình ảo hoá trực quan dành riêng cho bài giảng của bạn.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-14 items-center">
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <h3 className="text-3xl font-black text-sky-950">Xây dựng thế giới trực quan với Simulab AI</h3>
